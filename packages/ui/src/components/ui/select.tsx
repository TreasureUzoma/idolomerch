...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "ui-flex ui-h-10 ui-w-full ui-items-center ui-justify-between ui-rounded-md ui-border ui-border-slate-200 ui-bg-white ui-px-3 ui-py-2 ui-text-sm ui-ring-offset-white data-[placeholder]:ui-text-slate-500 focus:ui-outline-none focus:ui-ring-2 focus:ui-ring-slate-950 focus:ui-ring-offset-2 disabled:ui-cursor-not-allowed disabled:ui-opacity-50 [&>span]:ui-line-clamp-1 dark:ui-border-slate-800 dark:ui-bg-slate-950 dark:ui-ring-offset-slate-950 dark:data-[placeholder]:ui-text-slate-400 dark:focus:ui-ring-slate-300",
      className
    )}
    {...props}
  >
...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "ui-relative ui-z-50 ui-max-h-[--radix-select-content-available-height] ui-min-w-[8rem] ui-overflow-y-auto ui-overflow-x-hidden ui-rounded-md ui-border ui-border-slate-200 ui-bg-white ui-text-slate-950 ui-shadow-md data-[state=open]:ui-animate-in data-[state=closed]:ui-animate-out data-[state=closed]:ui-fade-out-0 data-[state=open]:ui-fade-in-0 data-[state=closed]:ui-zoom-out-95 data-[state=open]:ui-zoom-in-95 data-[side=bottom]:ui-slide-in-from-top-2 data-[side=left]:ui-slide-in-from-right-2 data-[side=right]:ui-slide-in-from-left-2 data-[side=top]:ui-slide-in-from-bottom-2 ui-origin-[--radix-select-content-transform-origin] dark:ui-border-slate-800 dark:ui-bg-slate-950 dark:ui-text-slate-50",
        position === "popper" &&
